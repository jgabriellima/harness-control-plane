...
const $$id = createComponent(($$result, $$props, $$slots) => {
  ...
  const workflowId = id ?? "";
  const title = workflowId ? `Workflow — ${workflowId}` : "Workflow";
  return renderTemplate`${renderComponent($$result, "AppLayout", $$AppLayout, { "title": title })}`;
}, "/Users/joaogabriellima/Documents/Work/jambu/harness-control-plane/src/pages/workflow/[id].astro", void 0);

const $$file = "/Users/joaogabriellima/Documents/Work/jambu/harness-control-plane/src/pages/workflow/[id].astro";
