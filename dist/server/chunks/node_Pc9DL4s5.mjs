...
let baseService, detector, node___js, parseQuality, resolveDefaultOutputFormat;
let __tla = Promise.all([
    ...
    resolveDefaultOutputFormat = function(sourceFormat) {
    ...
    async function fetchWithRedirects(options) {
        const { url, headers, imageConfig, fetchFn = globalThis.fetch, redirectLimit = 10, onMaxRedirectsExceeded = (_u)=>new Error("Maximum redirect depth exceeded"), onMissingLocationHeader = (_s, _u)=>new Error(`Redirect response ${_s} missing Location header`), onDisallowedRedirect = (_current, _target)=>new Error(`The image at ${_current} redirected to ${_target}, which is not an allowed remote location.`) } = options;
        if (redirectLimit <= 0) {
    ...
    async function getConfiguredImageService() {
        if (!globalThis?.astroAsset?.imageService) {
            const { default: service } = await import('./sharp_BzkDGTD0.mjs').then(async (m)=>{
                await m.__tla;
                return m;
            }).catch((e)=>{
    ...
    }, "/Users/joaogabriellima/Documents/Work/jambu/harness-control-plane/node_modules/astro/components/Image.astro", void 0);
    ...
    }, "/Users/joaogabriellima/Documents/Work/jambu/harness-control-plane/node_modules/astro/components/Picture.astro", void 0);
    ...
    }, "/Users/joaogabriellima/Documents/Work/jambu/harness-control-plane/node_modules/astro/components/Font.astro", void 0);
    ...
    const outDir = new URL("file:///Users/joaogabriellima/Documents/Work/jambu/harness-control-plane/dist/client/");
    const serverDir = new URL("file:///Users/joaogabriellima/Documents/Work/jambu/harness-control-plane/dist/server/");
    ...
    const handleImageRequest = async ({ request, loadLocalImage })=>{
        ...
        if (transform.format === "svg") {
            ...
            if (sourceFormat !== "svg") {
                return new Response("Cannot convert non-SVG source to SVG format", {
                    status: 403
                });
            }
        }
    ...
    const page = ()=>_page;
    node___js = Object.freeze(Object.defineProperty({
        __proto__: null,
        page
    }, Symbol.toStringTag, {
        value: 'Module'
...
export { baseService as b, detector as d, node___js as n, parseQuality as p, resolveDefaultOutputFormat as r, __tla };
