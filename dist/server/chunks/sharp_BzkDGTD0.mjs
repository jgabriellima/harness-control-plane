import { A as AstroError, N as NoImageMetadata, U as UnsupportedImageFormat, v as MissingSharp, __tla as __tla_0 } from './server_CDSaKx-0.mjs';
import { b as baseService, d as detector, r as resolveDefaultOutputFormat, p as parseQuality, __tla as __tla_1 } from './node_Pc9DL4s5.mjs';
let sharp_default, resolveSharpEncoderOptions;
let __tla = Promise.all([
    ...
    resolveSharpEncoderOptions = function(transform, inputFormat, serviceConfig = {}) {
        const quality = resolveSharpQuality(transform.quality);
        if (transform.format === void 0) {
            return quality === void 0 ? void 0 : {
                quality
            };
        }
    ...
    async function loadSharp() {
        let sharpImport;
        try {
            sharpImport = (await import('sharp').then(async (m)=>{
                await m.__tla;
                return m;
            })).default;
        } catch  {
    ...
    const sharpService = {
        ...
        async transform (inputBuffer, transformOptions, config) {
            ...
            let info;
            try {
                ({ data, info } = await result.toBuffer({
...
export { sharp_default as default, resolveSharpEncoderOptions, __tla };
