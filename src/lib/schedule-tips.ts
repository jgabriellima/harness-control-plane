export const SCHEDULE_INTERVIEW_CONVERSATION_ID = 'schedule-interview';
...
export const SCHEDULE_TIPS: ScheduleTip[] = [
  {
    id: 'daily-brief',
    title: 'Daily brief',
    description: 'Personalized daily briefing on topics you care about most',
    prompt:
      'Send me a daily briefing about the topics I care about most — AI, software engineering, and public-sector tech.',
    icon: 'sun',
  },
  {
    id: 'email-monitor',
    ...
    prompt:
      'Scan my emails every morning and let me know anything that needs my attention.',
    icon: 'mail',
  },
  {
    id: 'research-digest',
    ...
    prompt:
      'Send me high-signal papers and engineering reports about agentic systems every Friday.',
    icon: 'globe',
  },
  {
    id: 'job-scan',
    ...
    prompt:
      'Let me know when strong LATAM-to-U.S. part-time AI consulting roles appear.',
    icon: 'briefcase',
  },
  {
    id: 'weekly-routine',
...
export const SCHEDULE_INTERVIEW_AGENT_BRIEF = `[schedule_interview mode]
