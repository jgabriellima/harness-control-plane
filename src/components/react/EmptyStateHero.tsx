    ...
    <div className="flex flex-col items-center text-center" data-testid="empty-state-hero">
      <div className="mb-6 flex h-24 w-32 items-center justify-center">
        <div className="relative">
          <div className="flex h-16 w-20 items-center justify-center rounded-2xl bg-violet-100/80">
          ...
          <div className="absolute -right-4 -top-2 flex h-10 w-10 items-center justify-center rounded-xl bg-violet-50 shadow-sm">
