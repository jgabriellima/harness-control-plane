...
import {
  performComputerUsePreviewClick,
  performComputerUsePreviewKeyPress,
  performComputerUsePreviewType,
  setComputerUsePreviewControlMode,
} from '../../../../../lib/runtime-computer-use-panel-bridge';
import type { ComputerUseControlMode } from '../../../../../lib/runtime-computer-use-panel-types';

function isRecord(value: unknown): value is Record<string, unknown> {
  return typeof value === 'object' && value !== null;
}

function parseControlMode(value: unknown): ComputerUseControlMode | null {
